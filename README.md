## umx_driver (jazzy) - 1.0.1-1

The packages in the `umx_driver` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release umx_driver -r jazzy -t jazzy` on `Fri, 17 Jan 2025 11:54:48 -0000`
